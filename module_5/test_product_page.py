...
#        assert page.is_element_present(*LoginPageLocators.LOGIN_FORM) and \
#               page.is_element_present(*LoginPageLocators.REGISTER_FORM), "Not on the page LOGIN_FORM or REGISTER_FORM"
